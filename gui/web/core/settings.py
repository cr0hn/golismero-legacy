...
SECRET_KEY = 'd0s5v90soajsdlfu8iu1j1jk11kjl181hciaiaiudhjkasdjzx#mfk*06@(3jt!60l1%88xd)r1huve'
...
REST_API_TIMEOUT       = 1800 # 5 seconds
...
LOGGING = {
    ...
    'handlers': {
        ...
        'log_file':{
            ...
            'filename': os.path.join((os.path.dirname(__file__)), "golismero_web.log"),
