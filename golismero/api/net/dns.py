        ...
        for ardata in answer_in.response.answer:
            for rdata in ardata:
                ...
                if register_type == "A":
                    ...
                    m_return_append(DnsRegisterMX(answer.exchange,
                                                  answer.preference))
                    ...
                    m_return_append(DnsRegisterSOA(answer.mname,
                                                   answer.rname,
                                                   answer.refresh,
                                                   answer.expire))
                    ...
                    m_return_append(DnsRegisterSRV(answer.target,
                                                   answer.priority,
                                                   answer.weight,
                                                   answer.port))
