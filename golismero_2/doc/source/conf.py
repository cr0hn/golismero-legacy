...
# sphinx-quickstart on Tue Mar 19 16:23:29 2013.
#
...
sys.path.insert(0, os.path.abspath(os.path.join('..', '..', 'thirdparty_libs')))
...
project = u'GoLismero'
copyright = u'2010-2013, GoLismero Project'
...
texinfo_documents = [
  ('index', 'GoLismero', u'GoLismero Documentation',
   u'GoLismero Project', 'GoLismero', 'GoLismero, The Web Knife.',
   'Miscellaneous'),
]
...
epub_copyright = u'2010-2013, GoLismero Project'
