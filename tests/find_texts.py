...
#
# Check the performance searching text in a list of words
#
num_tests = 5
m_search_text = "Apache"
m_banners = [
        "0W 0.8c",
        "4D WebSTAR 2.0",
        "4D WebSTAR 2.1.1",
...
def method_for():
	...
	a=[x for x in m_banners if m_search_text in x]
	print "For method found: %s" % str(len(a))

#----------------------------------------------------------------------
def method_filer():
	"""Using find"""

	a=filter(lambda x: m_search_text in x, m_banners)
	print "Filter method found: %s" % str(len(a))
...
print ""
print "'For' library time: %s s" % str(timeit.timeit("method_for()", setup="from __main__ import method_for", number=num_tests))
print ""
print "'Filter' library time: %s s" % str(timeit.timeit("method_filer()", setup="from __main__ import method_filer", number=num_tests))