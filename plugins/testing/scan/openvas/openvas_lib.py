...
class VulnscanManager(object):
    ...
    #----------------------------------------------------------------------
    @classmethod
    def connectOpenVas(cls, host, user, password, port=9390, timeout=None):
        """
        ...
        try:
            ...
            raise VulnscanServerError("Error while connecting to the server. Error: %s" % str(e))
    ...
    def launch_scan(self, target, **kwargs):
        ...
        If you set a callback, probabilly you want to configure your
        code like this, if you want to wait the finish of the scan:
